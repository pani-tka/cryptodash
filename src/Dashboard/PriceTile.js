...
import { CoinGridHeaderStyled } from '../Settings/CoinHeaderGrid';
...
function ChangePercent({ data }) {
  return (
    <JustifyRight>
      <ChangePtc red={data.CHANGEPCT24HOUR < 0}>{numberFormat(data.CHANGEPCT24HOUR)}%</ChangePtc>
    </JustifyRight>
  );
}
